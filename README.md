...
(need to asked what qualifies accessibility standards)

WHEN I view the source code
THEN I find semantic HTML elements
<article> forum post, blog post, user comments, 
product cards, and news paper
<Section> chapters, intro, news items, contact information
<nav> 
<aside>
